rule pangrowth_hist:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_hist/{k}/{asmset}.log"
    benchmark:
        "results/benchmarks/5.quality_assessment/pangrowth_hist/{k}/{asmset}.txt"
    threads:
...
rule pangrowth_hist_plot:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_hist_plot/{asmset}/{k}.log"
    benchmark:
...
rule pangrowth_growth:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_growth/{asmset}/{k}.log"
    benchmark:
...
rule pangrowth_growth_plot:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_growth_plot/{asmset}/{k}.log"
    benchmark:
...
rule pangrowth_core:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_core/{asmset}/{k}.log"
    benchmark:
...
rule pangrowth_core_plot:
    ...
    log:
        "results/logs/5.quality_assessment/pangrowth_core_plot/{asmset}/{k}.log"
    benchmark:
