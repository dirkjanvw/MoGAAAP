rule fcs_gx:
    ...
    output:
        report = report("results/{asmname}/5.quality_control/03.fcs/{asmname}.fcs_gx_report.txt",
...
rule fcs_adaptor:
    ...
    output:
        ...
        fcsadaptorrpt = report("results/{asmname}/5.quality_control/03.fcs/{asmname}/fcs_adaptor_report.txt",
            category="Contamination",
