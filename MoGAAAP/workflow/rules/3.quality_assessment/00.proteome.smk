rule get_proteome:
    ...
    benchmark:
        "results/benchmarks/3.quality_assessment/proteome/{asmname}.txt",
    conda:
        "../../envs/agat.yaml"
    shell:
...
rule extract_isoforms:
    input:
        "results/{asmname}/3.quality_assessment/proteome.pep.fa",
    output:
        "results/{asmname}/3.quality_assessment/proteome.splice",
    log:
        "results/logs/3.quality_assessment/isoforms/{asmname}.log",
    benchmark:
        "results/benchmarks/3.quality_assessment/isoforms/{asmname}.txt",
    shell:
